...
## Комментарий к заданию про частотные словари

Количество токенов в лемматизированном тексте гораздо меньше, чем в нелемматизированном, потому что многие словоформы были заменены одной леммой. Все слова в лемматизированном тексте в начальной форме, поэтому частота употреблений некоторых из них увеличилась, то есть они стали выше в частотном словаре. Количество типов слов также уменьшилось, потому что в изначальном тексте были сохранены все словоформы, а в число типов слов входят, например, как настоящие, таак и прошедшие времена глаголов, все падежи. В лемматизированном тексте это заменилось на один тип слова - его начальную форму.
